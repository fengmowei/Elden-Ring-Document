...
window.onload=function(){
  ...
  xmlhttp.open("get","text/chn"+[game]+"/"+[type]+"_remk.xml",false);
  xmlhttp.send(null);
  xmlDoc=xmlhttp.responseXML;
  ...
  xmlhttp.open("get","text/jap"+[game]+"/"+[type]+"_remk.xml",false);
  xmlhttp.send(null);
  xmlDoc=xmlhttp.responseXML;
  ...
  xmlhttp.open("get","text/eng"+[game]+"/"+[type]+"_remk.xml",false);
  xmlhttp.send(null);
  xmlDoc=xmlhttp.responseXML;
