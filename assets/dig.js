...
window.onload = function () {
    ...
    for (var i = 0; i < Math.max(xmlc.getElementsByTagName("text").length, xmlj.getElementsByTagName("text").length, xmle.getElementsByTagName("text").length); i++) {
